...
#: части запроса, которые лента понимает. «liked» остался за API: отдельного
#: экрана «Избранное» на странице больше нет — отмеченное руками лежит в
#: «Сохранённых», — но 👍 по-прежнему уходит боту, и спросить у ленты, что
#: читателю понравилось, есть чем.
